...
def upgrade() -> None:
    ...
    if 'users' not in existing_tables:
        op.create_table(
            ...
            sa.Column('is_active', sa.Boolean(), nullable=False, server_default=sa.text('1' if is_sqlite else 'true')),
    ...
    if 'donations' not in existing_tables:
        op.create_table(
            ...
            sa.Column('show_donor_name', sa.Boolean(), nullable=False, server_default=sa.text('1' if is_sqlite else 'true')),
